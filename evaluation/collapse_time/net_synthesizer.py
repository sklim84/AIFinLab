...
for model_item in models:
    ...
    for n_gen_samples in n_gen_samples_arr:
        ...
        print(f"##### {model} {n_gen_samples} Total synthetic data generation time: {time.time() - start_time:.2f} seconds")
        ...
        synthetic_data.to_csv(f'./results/hf_{model_name[i]}_syn_{n_gen_samples}_3.csv', index=False)
