...
parser.add_argument('--origin_data_name', type=str, default='hf_training') # hf_ctgan_training
# hf_ctgan_training hf_ctgan_syn_10000KG_10k_1 hf_ctgan_base_10000KG_base_1
parser.add_argument('--data_name', type=str, default='hf_ctgan_syn_10000KG_10k_1')
...
parser.add_argument('--n_estimators', type=int, default=5)  # LGBM, XGBoost   # 100
...
# CatBoost
parser.add_argument('--iterations', type=int, default=500)  # 500
